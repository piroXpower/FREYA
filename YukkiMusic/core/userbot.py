        ...
        if config.STRING1:
            ...
            try:
                await self.one.send_message(
                    config.LOG_GROUP_ID, "Assistant One Started Successfully"
                )
            except:
        ...
        if config.STRING2:
            ...
            try:
                await self.two.send_message(
                    config.LOG_GROUP_ID, "Assistant Two Started Successfully"
                )
            except:
                LOGGER(__name__).error(
        ...
        if config.STRING3:
            ...
            try:
                await self.three.send_message(
                    config.LOG_GROUP_ID, "Assistant Three Started Successfully"
                )
            except:
                LOGGER(__name__).error(
        ...
        if config.STRING4:
            ...
            try:
                await self.four.send_message(
                    config.LOG_GROUP_ID, "Assistant Four Started Successfully"
                )
            except:
                LOGGER(__name__).error(
        ...
        if config.STRING5:
            ...
            try:
                await self.five.send_message(
                    config.LOG_GROUP_ID, "Assistant Five Started Successfully"
                )
            except:
                LOGGER(__name__).error(
