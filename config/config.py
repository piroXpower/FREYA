...
# Your Donation Url... For Donations In Bot
DONATION_URL = getenv("DONATION_URL", None)
...
# Images
START_IMG_URL = getenv("START_IMG_URL", "https://telegra.ph/file/4f5e749c0b92e61e6a09f.jpg")
